...
module AttributeTests = 
    ...
    type TestStringType = { [<PartitionKey>] StringProp: string }
    ...
    let private PartitionKeyAttribute_ShouldAllowUsageOnStringProperties() =
        ...
        let result = AttributeHelpers.getPartitionKeyFrom subject
    ...
    let private PartitionKeyAttribute_MissingAttributeShouldThrow() =
        ...
        Expect.throwsT<ArgumentNullException>
            <| (fun _ -> AttributeHelpers.getPartitionKeyFrom subject |> ignore)
    ...
    let attributeTests =
        testList "Attribute Tests" [
            ...
            testCase
                " A property must use the PartitionKeyAttribute"
                PartitionKeyAttribute_MissingAttributeShouldThrow
